...
async function runFullScan() {
  ...
  if(state.activeView==='live') { renderSignals(); }
...
// ── ALERT LOG — rendered live by alertManager._renderLogDOM() ─────
// alertManager.fire() updates the DOM immediately on every signal.
